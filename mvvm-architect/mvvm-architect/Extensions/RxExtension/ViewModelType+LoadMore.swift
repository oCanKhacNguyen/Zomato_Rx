...
extension ViewModelType {
    func setUpLoadMorePaging<T>(loadTrigger: Driver<Void>,
                                ...
                                loadMoreItems: @escaping (Int, Int) -> Observable<PagingInfo<T>>)
...
extension ViewModelType {
    func setupLoadMorePagingWithParam<T, U>(loadTrigger: Driver<U>,
                                            ...
                                            loadMoreItems: @escaping (U, Int, Int) -> Observable<PagingInfo<T>>)
        -> (page: BehaviorRelay<PagingInfo<T>>,
            fetchItems: Driver<Void>,
            error: Driver<Error>,
            loading: Driver<Bool>,
        ...
        let loadMoreItems = loadMoreTrigger
            ...
            .flatMapLatest { arg -> Driver<PagingInfo<T>> in
                let start = pageSubject.value.startItemIndex
                let shown = pageSubject.value.shownItems
                return loadMoreItems(arg, start, shown)
                    .trackError(errorTracker)
